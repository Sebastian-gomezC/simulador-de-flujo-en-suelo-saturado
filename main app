...
Imagen=tkinter.PhotoImage(file="/home/sebastian/Documents/proyecto_simulacion/foto.png")

imagen_1=tkinter.Label(Ventana,image=Imagen)
imagen_1.place(relx=0.45,rely=0.05)
